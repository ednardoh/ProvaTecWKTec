...
type
  TfrmVendasdiaria = class(TForm)
    ...
    procedure Edt_DataInicialKeyPress(Sender: TObject; var Key: Char);
  private
...
procedure TfrmVendasdiaria.Edt_DataInicialKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then Edt_DataFinal.SetFocus;
