object frmCad_Clientes: TfrmCad_Clientes
  ...
  object pn_Clientes: TPanel
    ...
    object pn_Controls: TPanel
      ...
      object EDTCnpjcpf: TcxDBTextEdit
        Left = 107
        Top = 18
  ...
  object pn_Grid: TPanel
    ...
    object grd_Clientes: TcxGrid
      ...
      object grd_ClientesDBTableView1: TcxGridDBTableView
        ...
        object grd_ClientesCNPJ_CPF: TcxGridDBColumn
          Caption = 'CNPJ/CPF'
  ...
  object TB_Clientes: TClientDataSet
    ...
    object TB_ClientesCNPJ_CPF: TStringField
      FieldName = 'CNPJ_CPF'
      Origin = 'CNPJ_CPF'
      FixedChar = True
    end
  ...
  object Prn_Cliente: TdxComponentPrinter
    CurrentLink = Prn_ClienteLink1
    PreviewOptions.Caption = 'Rela'#231#227'o de Clientes'
    PrintTitle = 'Rela'#231#227'o de Clientes'
    Version = 0
    Left = 504
    Top = 377
    PixelsPerInch = 96
    object Prn_ClienteLink1: TdxGridReportLink
      Active = True
      Component = grd_Clientes
      ...
      ReportDocument.CreationDate = 45599.665126979170000000
