...
procedure TfrmEntradaProduto.btnAnteriorClick(Sender: TObject);
begin
  TB_EntradaProduto.Next;
end;
...
procedure TfrmEntradaProduto.btnEditarClick(Sender: TObject);
begin
  Controlabotao(True, True, False, True, True);
  TB_EntradaProduto.Edit;
  Edt_IDProduto.SetFocus;
end;

procedure TfrmEntradaProduto.btnExcluirClick(Sender: TObject);
begin
  TB_EntradaProduto.Delete;
end;

procedure TfrmEntradaProduto.btnInserirClick(Sender: TObject);
begin
  Controlabotao(True, True, False, True, True);
  TB_EntradaProduto.Append;
  Edt_IDProduto.SetFocus;
end;

procedure TfrmEntradaProduto.btnPrimeiroClick(Sender: TObject);
begin
  TB_EntradaProduto.First;
end;

procedure TfrmEntradaProduto.btnProximoClick(Sender: TObject);
begin
  TB_EntradaProduto.Prior;
end;

procedure TfrmEntradaProduto.btnSalvarClick(Sender: TObject);
begin
  TB_EntradaProduto.Post;
end;

procedure TfrmEntradaProduto.btnUltimoClick(Sender: TObject);
begin
  TB_EntradaProduto.Last;
end;
...
begin
  ...
  begin
    ...
    Edt_ValUnitCompra.Text := frmPrincipal.LPrcProd;
  end
  else
  begin
...
procedure TfrmEntradaProduto.Controlabotao(vInsert, vExcluir, vEditar, vSalvar,
  vCancelar: Boolean);
begin
